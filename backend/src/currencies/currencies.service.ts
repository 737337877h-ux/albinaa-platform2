...
export class CurrenciesService {
  ...
  async update(code: string, dto: UpdateCurrencyDto, actor: AuthUser, req?: Request) {
    ...
    await this.audit.log({
      ...
      oldValue: {
        sourceCode: before.sourceCode, nameAr: before.nameAr, decimals: before.decimals,
        active: before.active, exchangeRate: before.exchangeRate.toString(),
      },
      newValue: {
        sourceCode: currency.sourceCode, nameAr: currency.nameAr, decimals: currency.decimals,
        active: currency.active, exchangeRate: currency.exchangeRate.toString(),
      },
      req,
    });
    return currency;
